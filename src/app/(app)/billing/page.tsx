...
export default function BillingPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">과금현황</h1>
      ...
      <Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-sky-50 dark:border-[#005AE0]/20 dark:from-[#121A2E] dark:to-[#0A1628]">
        <CardContent className="p-6">
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-blue-100 p-3 dark:bg-[#005AE0]/15">
              <Calculator className="h-6 w-6 text-blue-600 dark:text-[#005AE0]" />
            </div>
            <div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalCount}건</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">40원</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border border-gray-200 bg-white dark:border-[#1E2942] dark:bg-[#121A2E]">
        <CardHeader>
          <CardTitle className="text-base text-gray-900 dark:text-gray-200">월별 과금 추이</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border border-gray-200 bg-white dark:border-[#1E2942] dark:bg-[#121A2E]">
        <CardHeader>
          <CardTitle className="text-base text-gray-900 dark:text-gray-200">월별 과금 내역</CardTitle>
        </CardHeader>
              ...
              <tbody>
                {billingHistory.map((b) => (
                  <tr key={b.month} className="border-b border-gray-100 last:border-0 dark:border-[#1E2942]/50">
                    <td className="px-5 py-3 font-medium text-gray-900 dark:text-gray-200">{b.month}</td>
                    <td className="px-5 py-3 text-right text-gray-600 dark:text-gray-300">
                      {b.transactionCount.toLocaleString()}건
                    </td>
                    <td className="px-5 py-3 text-right text-gray-500 dark:text-gray-400">{b.unitPrice}원</td>
